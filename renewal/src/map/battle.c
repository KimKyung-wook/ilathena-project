			...
			default:
			{
				...
				switch(skill_num){
					...
					case NPC_EARTHQUAKE:
						...
						break;
// 3rd Class Skills. [The Quality Maker]
//=======================================================================================
					case AB_JUDEX:
...
// eAthena additions
	...
	{ "save_warp_map",                      &battle_config.save_warp_map,                   1,      0,      1,              },
...
// iLAthena 추가옵션 ─────────────────────────────────────────────────────
	// 차암 시스템 사용여부설정 [★orz。]
	{ "keepitem_use",                       &battle_config.keepitem_use,                    0,      0,      1,              },
	// 즉시효과 아이템 사용여부설정 [★orz。]
	{ "immediateitem_use",                  &battle_config.immediateitem_use,               0,      0,      1,              },
	// 카드 확률 삽입 시스템 사용여부 [★orz。]
	{ "probcard_use",                  &battle_config.probcard_use,               0,      0,      1,              },
	// 몬스터드랍장비아이템 감정여부설정 [Sapientia]
	{ "drop_item_identify",                 &battle_config.drop_item_identify,              0,      0,      1,              },
	// 균등파티 100% 경험치 여부설정 [Sapientia]
	{ "party_exp_share",                    &battle_config.party_exp_share,                 0,      0,      1,              },
	// 전체채팅 [JaVb, 사이버짱]
	{ "charkami_useitem",					&battle_config.charkami_useitem,				0,		0,		1,				},
	{ "charkami_usemoney",					&battle_config.charkami_usemoney,				0,		0,		MAX_ZENY,		},
	{ "charkami_usegrantlevel",				&battle_config.charkami_grantlevel,				0,		0,		MAX_LEVEL,		},
	{ "charkami_useitemcode",				&battle_config.charkami_useitemcode,			12221,	501,	MAX_ITEMDB,		},
	{ "charkami_useitemamount",				&battle_config.charkami_useitemamount,			0,		0,		INT_MAX,		},
//──────────────────────────────────────────────────────────────
};
