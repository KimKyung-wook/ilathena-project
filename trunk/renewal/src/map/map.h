...
extern int event_tid; // @이벤트 명령어 [JaVb]
extern int event_tick; // @이벤트 명령어 [JaVb]
extern int event_rate; // @이벤트 명령어 [JaVb]
extern int event_dflag; // @이벤트 명령어 [JaVb]
extern int event_eflag; // @이벤트 명령어 [JaVb]
