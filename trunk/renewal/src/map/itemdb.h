...
//		some script commands should be revised as well...
	...
	int limit_lv_min, limit_lv_max;

	int probcard_percentage;	// 카드확률조합시스템[★orz。]
	int probcard_del;	// 카드확률조합시스템[★orz。]
};
